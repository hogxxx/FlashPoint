...
public class OrderObject : MonoBehaviour
{
    ...
    private static List<List<string>> Bio_9 = new List<List<string>>()
    {
        new List<string>
        {
            ...
            "Мітоз це поділ клітини на дві дочірні"
        },
    ...
    private static List<List<string>> Bio_10 = new List<List<string>>()
    {
        new List<string>
        {
            ...
            "Біосфера це глобальна екосистема Землі включає всі живі організми"
        },
    ...
    private static List<List<string>> Bio_11 = new List<List<string>>()
    {
        new List<string>
        {
            ...
            "Ендемічний вид це вид що мешкає в одній області"
        },

        new List<string>
        {
            "Мікроорганізми це організми видимі тільки під мікроскопом",
            "Селекція це процес створення нових сортів рослин",
    ...
    private static List<List<string>> Chem_8 = new List<List<string>>()
    {
        ...
        new List<string>
        {
            "Окиснення це процес втрати електронів атомом",
    ...
    private static List<List<string>> Chem_9 = new List<List<string>>()
    {
        ...
        new List<string>
        {
            ...
            "Ізомерія це існування сполук однакової формулою але різної будови"
        },
    ...
    private static List<List<string>> Phys_10 = new List<List<string>>()
    {
        ...
        new List<string>
        {
            "Гармонічні коливання це рух повторюється через рівні проміжки часу",
    ...
    private static List<List<string>> IT_11 = new List<List<string>>()
    {
        ...
        new List<string>
        {
            "Інтернет речей це мережа пристроїв для обміну даних інтернетом",
        ...
        new List<string>
        {
            ...
            "Великі дані це великі обсяги інформації для аналізу обробки",
    ...
    private static List<List<string>> Math_9 = new List<List<string>>()
    {
        new List<string>
        {
            ...
            "Логарифм це показник степеня до якого підносять основу",
        ...
        new List<string>
        {
            ...
            "Ось симетрії це пряма що ділить фігуру навпіл"
        },
    ...
    private static List<List<string>> Math_11 = new List<List<string>>()
    {
        ...
        new List<string>
        {
            ...
            "Еліпс це точки сума відстаней яких до фокусів стала"
        }
    };
